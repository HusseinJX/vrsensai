...
namespace XRMultiplayer
{
    public class AuthenticationManager : MonoBehaviour
    {
        ...
        string CheckMPPM()
        {
            ...
            if(Unity.Multiplayer.PlayMode.CurrentPlayer.Tags.Count > 0)
            {
                mppmString += Unity.Multiplayer.PlayMode.CurrentPlayer.Tags[0];
        ...
        {
            // Check to make sure it's an MPPM Virtual Player.
            if (focus && Unity.Multiplayer.PlayMode.CurrentPlayer.Tags.Count > 0)
            {
