...
namespace XRMultiplayer
{
    ...
    public class NetworkPhysicsInteractable : NetworkBaseInteractable
    {
        ...
        void Update()
        {
            ...
            // Skip network velocity calculations in offline mode for better performance
            if (XRINetworkGameManager.Instance != null && XRINetworkGameManager.Instance.offlineMode)
            {
                return;
            }
